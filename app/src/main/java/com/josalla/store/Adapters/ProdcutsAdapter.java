...
public class ProdcutsAdapter extends RecyclerView.Adapter<ProdcutsAdapter.MyViewHolder> {

    Activity activity;
    ArrayList<Products> data;

    public ProdcutsAdapter(Activity activity, ArrayList<Products> data) {
    ...
    @NonNull
    @Override
    public ProdcutsAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

        View root = LayoutInflater.from(activity).inflate(R.layout.product_item, null, false);
        return new MyViewHolder(root);
    }

    //----------------------------------------------------------تركيب البيانات-----------------------------------------------
    @Override
    public void onBindViewHolder(@NonNull ProdcutsAdapter.MyViewHolder holder, final int position) {
