 ...
 */
public class MothersFragment extends Fragment {
    ...
    final static String main_category = "الأم والأطفال";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View fragment = inflater.inflate(R.layout.fragment_mothers, container, false);
