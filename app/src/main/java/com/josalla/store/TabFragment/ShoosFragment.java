 ...
 */
public class ShoosFragment extends Fragment {
    ...
    final static String main_category = "الأحذية";

    public ShoosFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View fragment = inflater.inflate(R.layout.fragment_shoos, container, false);
