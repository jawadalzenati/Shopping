 ...
 */
public class CartsyFragment extends Fragment {
    ...
    final static String main_category = "القرطاسية";

    public CartsyFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View fragment = inflater.inflate(R.layout.fragment_cartsy, container, false);
